  ...
  <div class="counter__content">
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-6 text-center">
        <div>
          <img src="img/selo_qualidade.png" class="mb-3" alt="selo" width="100px">
          <p>O selo de satisfação representa a experiência positiva dos clientes.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 text-center">
        <div>
          <img src="img/selo_cau.png" class="mb-3" alt="selo" width="120px">
          <p>O emblema da "CAU Arquitetura" simboliza excelência, ética e avanço na arquitetura.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 text-center">
        <div>
          <img src="img/selo_leed.png" class="mb-3" alt="selo" width="120px">
          <p>O selo LEED é um reconhecimento para edifícios sustentáveis.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 text-center">
        <div>
          <img src="img/selo_acessibilidade.png" class="mb-3" alt="selo" width="100px">
          <p>O selo de acessibilidade garante igualdade de acesso a todos.</p>
        </div>
      </div>
    </div>
  </div>
